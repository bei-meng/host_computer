...
# 默认会定义一个寄存器变量zero,值为0
    const_uint8 per_points_bit, 4                                                                        # 每行能存多少数据2^4表示能存16个，对应v1
    const_uint8 per_points_sub1, 15
    #---------------------------------------------------------------------------------------------------每个dout_ram能存的最大数据
...
loop3:
    ...
    #---------------------------------------------------------------------------------------------------计算tia的base
    bge_r col_bank_num, four, tia_big4                                        # 如果col_bank_num >= 4，跳转到tia_big4
